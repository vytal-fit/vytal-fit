...
| D7 | **Loja online / merch com fornecedores externos** *(modelo, cor, tamanho, encomenda e tracking)* | JCUNHAFONTE + fornecedor | Fase posterior / marketplace; prever já a integração para dealers chineses e outros parceiros de produção. |
