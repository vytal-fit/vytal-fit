...
- Name: apps/web/e2e/smoke.spec.ts >> Smoke tests >> 404 page returns for unknown routes
- Location: apps/web/e2e/smoke.spec.ts:27:7
...
Call log:
  - navigating to "/this-route-does-not-exist", waiting until "load"
