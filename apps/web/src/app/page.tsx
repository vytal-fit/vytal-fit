...
const FOOTER_COL_META = [
  {
    ...
    links: [
      ...
      { labelKey: "fpNews",    href: "/signup" },
      { labelKey: "fpRoadmap", href: "/signup" },
      { labelKey: "fpApi",     href: "/signup" },
    ],
  },
  {
    titleKey: "footerResources",
    links: [
      { labelKey: "frHelp",      href: "/signup" },
      { labelKey: "frBlog",      href: "/signup" },
      { labelKey: "frVideos",    href: "/signup" },
      { labelKey: "frCommunity", href: "/signup" },
      { labelKey: "frStatus",    href: "/signup" },
    ],
  },
  {
    titleKey: "footerCompany",
    links: [
      { labelKey: "fcAbout",    href: "/signup" },
      { labelKey: "fcCareers",  href: "/signup" },
      { labelKey: "fcPartners", href: "/signup" },
      { labelKey: "fcPress",    href: "/signup" },
      { labelKey: "fcContact",  href: "/signup" },
    ],
  },
  {
    titleKey: "footerLegal",
    links: [
      { labelKey: "flTerms",   href: "/signup" },
      { labelKey: "flPrivacy", href: "/signup" },
      { labelKey: "flRgpd",    href: "/signup" },
      { labelKey: "flCookies", href: "/signup" },
      { labelKey: "flDpa",     href: "/signup" },
    ],
  },
];
