...
const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    // Nav group titles
    "nav.group.management": "Gestao",
    "nav.group.operations": "Operacoes",
    "nav.group.settings": "Definicoes",
    ...
    "auth.subtitle": "Plataforma inteligente para o seu espaco fitness",
    ...
    "auth.registerSubtitle": "Crie a sua conta para comecar",
    ...
    "dashboard.healthy": "Saudavel",
    "dashboard.needsAttention": "Precisa de atencao",
    "dashboard.noTraining7Days": "Sem treino ha 7+ dias",
    "dashboard.noClassesToday": "Sem aulas agendadas para hoje",

    // Members
    "members.title": "Membros",
    "members.subtitle": "Gerir os membros do seu box",
    "members.searchPlaceholder": "Pesquisar por nome, email ou numero de membro...",
    "members.name": "Nome",
    "members.email": "Email",
    ...
    "members.plan": "Plano",
    "members.lastCheckIn": "Ultimo Check-in",
    "members.streak": "Sequencia",
    ...
    "wods.strength": "Forca",
    "wods.coolDown": "Retorno a calma",
    "wods.timeCap": "Tempo limite",
    "wods.rounds": "Rondas",
    "wods.exercises": "Exercicios",
    ...
    "crm.lost": "Perdido",
    "crm.source": "Origem",
    "crm.assignedTo": "Atribuido a",
    "crm.notes": "Notas",

    // Common UI
    "ui.notifications": "Notificacoes",
    "ui.noData": "Sem dados",
    ...
    "ui.new": "novo",
    "ui.yourOrganizations": "As suas organizacoes",
    "ui.createNewOrg": "Criar nova organizacao",
    "ui.selectOrg": "Selecionar organizacao",
    "ui.language": "Idioma",
    "ui.theme": "Tema",
  ...
  es: {
    ...
    "auth.forgotPassword": "Olvidaste la contrasena?",
    ...
    "dashboard.noTraining7Days": "Sin entrenar hace 7+ dias",
    ...
    "members.searchPlaceholder": "Buscar por nombre, email o numero de miembro...",
    "members.name": "Nombre",
    "members.email": "Email",
    "members.phone": "Telefono",
    "members.status": "Estado",
    ...
    "classes.location": "Ubicacion",
    "classes.coach": "Coach",
    "classes.capacity": "Capacidad",
    "classes.enrolled": "Inscritos",
    "classes.waitlist": "Lista de espera",
    "classes.available": "Disponible",
    "classes.fillingUp": "Llenandose",
    "classes.full": "Lleno",
    ...
    "ui.createNewOrg": "Crear nueva organizacion",
    "ui.selectOrg": "Seleccionar organizacion",
    "ui.language": "Idioma",
    "ui.theme": "Tema",
